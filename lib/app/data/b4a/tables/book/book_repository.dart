...
import 'package:learning_about_b4a_2_dart/app/data/b4a/entity/book_entity.dart';
...
class BookRepository {
  ...
  addAll() async {
    ...
    authorModelList.addAll([
      BookModel(
        ...
        typeArray: ['a', '1'],
        typePointerPublisher: PublisherModel(objectId: 'Wcz1n0LD6I'),
      ),
      BookModel(
        typeString: 'Book02',
        typeBoolean: false,
        ...
        typeArray: ['b', '2'],
        typePointerPublisher: PublisherModel(objectId: '4pKta7jOJg'),
      ),
      BookModel(
        typeString: 'Book03',
        typeBoolean: true,
        ...
        typeArray: ['c', '3'],
        typePointerPublisher: PublisherModel(objectId: 'PVad0JzIeG'),
      ),
    ]);
  ...
  addRelations() async {
    ...
    parseObjectBook01.objectId = 'xSAvnM865g';
    ...
    parseObjectAuthor01.objectId = 'eAc886KdOl';
    parseRelationBook.add(parseObjectAuthor01);
    await parseObjectBook01.save();

    // log('addRelation 02');
    // final parseObjectBook02 = ParseObject(BookEntity.className);
    // parseObjectBook02.objectId = '1FaM0PzqRi';
    // final parseObjectAuthor02 = ParseObject(AuthorEntity.className);
    // parseObjectAuthor02.objectId = 's3wDYlIqoV';
  ...
  removeRelations() async {
    ...
    parseObjectBook.objectId = 'xSAvnM865g';
    final parseObjectAuthor = ParseObject(AuthorEntity.className);
    parseObjectAuthor.objectId = 'eAc886KdOl';
