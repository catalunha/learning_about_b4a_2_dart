  ...
  addAll() async {
    ...
    authorModelList.addAll([
      AuthorModel(
        ...
        typeArray: ['a', '1'],
        typePointerGenre: GenreModel(objectId: 'Qhk8ihK9qH'),
      ),
      AuthorModel(
        typeString: 'Author02',
        typeBoolean: false,
