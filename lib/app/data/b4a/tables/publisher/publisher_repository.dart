...
import 'package:learning_about_b4a_2_dart/app/core/models/shape_model.dart';
  ...
  addAll() async {
    ...
    authorModelList.addAll([
      PublisherModel(
        ...
        typeArray: ['a', '1'],
        typePointerShape: ShapeModel(objectId: '5qSDm1dxq6'),
      ),
      PublisherModel(
        ...
        typeArray: ['b', '2'],
        typePointerShape: ShapeModel(objectId: '2sINHyz78o'),
      ),
      PublisherModel(
        ...
        typeArray: ['c', '3'],
        typePointerShape: ShapeModel(objectId: 'DHiMBqAZg8'),
      ),
    ]);
